      ...
      <footer className="py-32 px-6 md:px-12 border-t border-black/5 dark:border-white/5 bg-white dark:bg-[#0A0A0B] relative overflow-hidden transition-colors duration-500">
        <div className="max-w-7xl mx-auto flex flex-col items-center gap-16 text-center">
           ...
           <div className="flex gap-4">
             ...
             <a href="https://www.linkedin.com/in/mohammed-nadeem-03/" target="_blank" rel="noopener noreferrer" className="w-16 h-16 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center hover:bg-slate-900 hover:text-white dark:hover:bg-white dark:hover:text-black transition-all">
                <Linkedin size={24} />
             </a>
